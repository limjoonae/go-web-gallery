...
export class TableDocument {
    ...
    [filterAll]="false" [columns]="columns_1" [data]="data" (onCellClicked)="cellClick($event)" id='table_basic'></go-table>`;
    code_2: string = `<go-table class="table table-striped table-border table-sm" [paging]=false 
    [filterAll]=true [columns]="columns_2" [data]="data" id='table_gb_filter'></go-table>`;
    ...
    [columns]="columns_3" [data]="data" id="table_column_filter"></go-table>`;
	...
	[data]="data_4" (onTableChanged)="tableChanged($event)" id="table_fetch"></go-table>`;
