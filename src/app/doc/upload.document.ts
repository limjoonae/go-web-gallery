...
const ATTRIBUTELIST: Array<any> = [
    ...
    { require: '', name: 'accept', type: 'string', description: `กำหนดประเภทของไฟล์ที่แสดงตอนเลือกไฟล์ โดยสามารถดูได้จาก<strong><a href="http://www.iana.org/assignments/media-types/media-types.xhtml">ลิงค์นี้</a></strong>` },
    { require: '', name: 'fileTypeAllow', type: 'string', description: `กำหนดประเภทของไฟล์ที่สามารถเลือกเพื่อที่จะอัพโหลดได้ โดยสามารถดูได้จาก<strong><a href="http://www.iana.org/assignments/media-types/media-types.xhtml">ลิงค์นี้</a></strong>` },
